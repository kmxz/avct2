...
const FAKE_RESULTS: Record<string, (params: { [key: string]: any }) => any> = {
    ...
    'tag': (): TagJson[] => [
        ...
        { id: 4, name: 'tag 4', best: 3333, parent: [], type: 'Format' },
        { id: 5, name: 'tag 5', parent: [2], type: 'Content' },
        { id: 6, name: 'tag 6', parent: [2], type: 'Content', description: 'foo description 6' },
        { id: 7, name: 'tag 7', parent: [], type: 'Studio'},
        { id: 8, name: 'tag 8', best: 2, parent: [], type: 'Content', description: 'foo description 8' },
        { id: 9, name: 'tag 9 or whatever may be long', best: 3, parent: [8], type: 'Content', description: 'foo description 9' },
        { id: 10, name: 'tag 10', best: 3, parent: [], type: 'Format', description: 'foo description a' },
        { id: 11, name: 'tag mistress gigiba is strange', parent: [7], type: 'Studio' },
        { id: 12, name: 'tag 12', parent: [], type: 'Special', description: 'foo description c' },
        ...
        { id: 16, name: 'tag 16', parent: [1], type: 'Studio' },
        { id: 17, name: 'tag 17', parent: [], type: 'Studio', description: 'now we get another overflow' },
    ],
    'tag/create': () => {
