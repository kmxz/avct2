/*
This file will convert SQLite database Avct_dbv1.db of old avct project to HSQLDB database Avct_dbv2.db of new avct2 
project.
...
public class Main {
    ...
    Main() throws ClassNotFoundException, SQLException {
        ...
        hsqldb = DriverManager.getConnection("jdbc:hsqldb:file:Avct_dbv2.db;shutdown=true;hsqldb.write_delay=false", 
"SA", "");
        tag();
        tagRelationship();
        studio();
    ...
    void tag() throws SQLException {
        ...
        PreparedStatement pstmt = hsqldb.prepareStatement("INSERT INTO \"PUBLIC\".\"tag\" (\"tag_id\", \"name\") 
VALUES(?, ?)");
    ...
    void tagRelationship() throws SQLException {
        Statement statement = sqlite.createStatement();
        PreparedStatement pstmt = hsqldb.prepareStatement("INSERT INTO \"PUBLIC\".\"tag_relationship\" 
(\"parent_tag\", \"child_tag\") VALUES(?, ?)");
    ...
    void studio() throws SQLException {
        Statement statement = sqlite.createStatement();
        PreparedStatement pstmt = hsqldb.prepareStatement("INSERT INTO \"PUBLIC\".\"studio\" (\"studio_id\", 
\"name\") VALUES(? ,?)");
    ...
    void clip() throws SQLException {
        Statement statement = sqlite.createStatement();
        PreparedStatement pstmt = hsqldb.prepareStatement("INSERT INTO \"PUBLIC\".\"clip\" (\"clip_id\", \"file\", 
\"studio_id\", \"race\", \"thumb\", \"grade\", \"size\", \"length\", \"role\", \"source_note\") VALUES(?, ?, ?, ?, 
?, ?, ?, ?, 0, '')");
        ResultSet rs = statement.executeQuery("SELECT clip_id, file, studio_id, race, thumb, grade, size, length 
FROM clip");
        while (rs.next()){
            pstmt.setInt(1, rs.getInt(1));
            pstmt.setString(2, rs.getString(2));
    ...
    void recParent(int clipId, int tagId, int level) throws SQLException {
        PreparedStatement pstmte = hsqldb.prepareStatement("SELECT * FROM \"PUBLIC\".\"clip_tag\" WHERE \"clip_id\" 
= ? AND \"tag_id\" = ?");
        ...
        PreparedStatement pstmti = hsqldb.prepareStatement("INSERT INTO \"PUBLIC\".\"clip_tag\" (\"clip_id\", 
\"tag_id\") VALUES(?, ?)");
...
= ?");
    ...
    void record() throws SQLException {
        Statement statement = sqlite.createStatement();
        PreparedStatement pstmt = hsqldb.prepareStatement("INSERT INTO \"PUBLIC\".\"record\" (\"timestamp\", 
\"clip_id\") VALUES(?, ?)");
